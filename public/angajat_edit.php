...
<?= $baloon; ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading" id="panel"><label for="panel" class="h4">Modifica datele angajatului : <?= $emp_dat['surname']." ".$emp_dat['name']?></label></div>
            <hr>
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']).'?id='.$_GET['id'] ?>" method="post">
                ...
                <div class="<?= $status["surname"]; ?>">
                    ...
                    <div class="col-sm-10 col-md-4 col-lg-3 form-group"><span
                        ...
                        <input type="text" name="surname" class="form-control" id="surname" placeholder="Prenume"
                               value="<?= $emp_dat['surname']?>" required>
                    </div>
                </div>
                <!--Al doilea prenume -->
                ...
                <div class="<?= $status["type_em"]; ?>">
                    ...
                    <div class="col-sm-10 col-md-4 col-lg-3 form-group"><span
                        ...
                        <select class="form-control" name="type_em">
                            <option value="angajat" <?php if ($emp_dat[7] == "0") {
                                echo "selected";
                            } ?>>Tip contract:
                            </option>
                            <option value="angajat" <?php if  ($emp_dat[7] == "angajat") {
                                echo "selected";
                            } ?>>Angajat
                            </option>
                            <option value="temp" <?php if  ($emp_dat[7] == "temp") {
                                echo "selected";
                            } ?>>Temmporar
                            </option>
                            <option value="child" <?php if  ($emp_dat[7] == "child") {
                                echo "selected";
                            } ?>>Minor
                            </option>
                        </select>
                ...
                <div class="col-sm-10 col-md-10 col-lg-11 form-group"><span
                    ...
                    <textarea name="comment" class="form-control" id="comment"
                              placeholder="Detalii suplimentare"><?= $emp_dat[9][0]?></textarea>
                </div>

                <!--Foc la ghete -->
                <div class="col-md-12 col-lg-12"></div>
                <button type="submit" name="submit" class="btn btn-lg btn-success btn-group-justified" id="submit">
                    Modifica <span class="glyphicon glyphicon-plus-sign"></span></button>
            </form>
        </div>
    </main>
